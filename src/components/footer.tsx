...
export default function Footer() {
  ...
  return (
    <div className="w-full bg-slate-200 dark:bg-slate-950 py-2 md:py-3 text-slate-950 dark:text-slate-200 flex items-center px-2 sm:px-4 justify-between shrink-0">
      <span className="inline-flex items-center md:hidden">
        <Sheet>
          ...
          <SheetContent side="left">
            ...
            {
              links.map(link => (
                <div className="px-4 sm:px-8 py-4 hover:bg-slate-200/70 dark:hover:bg-slate-800/70 rounded-2xl transition duration-300 ease-in-out">
                  <Link
                    href={link.href}
                  >
